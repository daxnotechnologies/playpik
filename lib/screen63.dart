...
class screen63 extends StatefulWidget {
  const screen63({Key, key}) : super(key: key);

  @override
  _screen63State createState() => _screen63State();
}

class _screen63State extends State<screen63> {
  @override
                        ...
                        Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Image.asset('assets/images/Group 7917@3x.png',height: 10,width: 10,),
                            ),
                            Expanded(child: Container(width: 1,color: Colors.transparent,)),
                          ],
                        ),
