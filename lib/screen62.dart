...
class _screen62State extends State<screen62> {
  @override
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.cancel_outlined,color: Colors.red.shade900,),
                        SizedBox(width: 10,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          children: [
                            Expanded(child: Container(width: 1,color:Colors.red.shade900.withOpacity(0.2),)),
                            Container(
                              height: 30,
                              width: 30,
                              ...
                              child:Icon(Icons.circle,size: 10,color: Colors.red.shade900,),
                            ),
                            Expanded(child: Container(width: 1,color:Colors.red.shade900.withOpacity(0.2),)),
                          ],
                        ),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Expanded(child: Container(width: 1,color: Colors.transparent,)),
                          ],
                        ),
                        SizedBox(width: 10,),
                        Padding(
