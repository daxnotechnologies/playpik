...
class screen70 extends StatefulWidget {
  const screen70({Key, key}) : super(key: key);
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
                                        ImageIcon(AssetImage('assets/images/Path 5203@3x.png'),size: 40,),
                                      ],
                                    ),
                                    // 15
                                    Text(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ImageIcon(AssetImage('assets/images/box@3x.png'),color: Theme.of(context).primaryColor,),
                            // Kupon Kodu Ekle
                            Text(
                                " Kupon Kodu Ekle",
                                style: const TextStyle(
